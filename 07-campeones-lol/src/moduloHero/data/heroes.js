export const heroes = [
    ...
    // Tiradores-ADC
    {
        ...
        'campeon':'Caitlyn',
        'publisher':'ADC',
        'alter_ego':'La Mejor Pacificadora',
        'first_appearance':'Lanzado En: 04/01/2011',
        'characters':'🥍🎯🥍',
        'description': 'Reconocida como la mejor pacificadora, Caitlyn también es la mejor oportunidad de Piltóver para deshacerse de los elementos criminales elusivos de su ciudad. A veces hace equipo con Vi y es un buen contrapunto para la naturaleza más impulsiva de su compañera. Aunque carga un rifle hextech único, el arma más poderosa de Caitlyn es su intelecto superior, el cual le permite tender trampas elaboradas para malhechores que son suficientemente tontos para operar en la Ciudad del Progreso.'
    },
    {
        'id': 'samira-adc',
        'campeon':'Samira',
        'publisher':'ADC',
        'alter_ego':'La Rosa Del Desierto',
        'first_appearance':'Lanzado En: 21/09/2021',
        'characters':'🌹🌹🌹',
        'description': 'Samira ve a la muerte a los ojos con una confianza obstinada, en busca de la emoción, adonde sea que vaya. Después de que su hogar shurimano fuera destruido cuando era niña, Samira encontró su verdadero llamado en Noxus, donde construyó su reputación de temeraria con estilo, asumiendo misiones peligrosas de alto riesgo. Con pistolas de pólvora negra y una espada de diseño personalizado, Samira triunfa bajo circunstancias de vida o muerte, eliminando con destreza y estilo a cualquiera que se interponga en su camino.'
    },
    {
        'id': 'kaisa-adc',
        'campeon':'Kai´sa',
        'publisher':'ADC',
        'alter_ego':'La Hija Del Vacio',
        'first_appearance':'Lanzado En: 07/03/2018',
        'characters':'🕳🖤🕳',
        'description': 'Reclamada por el Vacío cuando era tan solo una niña, KaiSa ha logrado sobrevivir a través de absoluta tenacidad y fuerza de voluntad. Sus experiencias la han convertido en una cazadora letal y, para algunos, el presagio de un futuro para el cual preferirían no vivir lo suficiente para no verlo. Ahora que forma parte de una inquietante simbiosis con un caparazón viviente del Vacío, pronto le llegará el momento en el que tendrá que decidir si perdona a los mortales que la consideraran un monstruo para vencer juntos a la oscuridad que se aproxima... o simplemente olvidar, mientras el Vacío consume el mundo que la dejó atrás.'
    },
    {
        'id': 'miss-adc',
        'campeon':'Miss Fortune',
        'publisher':'ADC',
        'alter_ego':'Capitana De Aguasturbias',
        'first_appearance':'Lanzado En: 08/09/2010',
        'characters':'🌍🌈💓',
        'description': 'Sarah Fortune, capitana de Aguasturbias famosa por su apariencia, pero temida por su brutalidad, es una figura severa entre los criminales más duros de la ciudad portuaria. Cuando era niña fue testigo de cómo el rey Gangplank asesinó a su familia, un acto que vengó brutalmente años después, explotando su barco mientras él estaba a bordo. Aquellos que la subestiman tendrán que enfrentar a un oponente seductor e impredecible... y probablemente una bala o dos en sus entrañas.'
    },
    {
        'id': 'xayah-adc',
        'campeon':'Xayah',
        'publisher':'ADC',
        'alter_ego':'La Rebelde',
        'first_appearance':'Lanzado En: 27/04/2017',
        'characters':'💫💥💤',
        'description': 'Letal y precisa, Xayah es una vastaya revolucionaria que lleva a cabo una guerra personal para salvar a su gente. Utiliza su velocidad, astucia y plumas afiladas para abatir a cualquiera que se interponga en su camino. Xayah pelea junto a su compañero y amante Rakan para proteger a su decreciente tribu y devolver la gloria a su raza.'
    },
    {
        'id': 'jinx-adc',
        'campeon':'Jinx',
        'publisher':'ADC',
        'alter_ego':'La Bala Perdida',
        'first_appearance':'Lanzado En: 10/10/2013',
        'characters':'🤪🤪🤪',
        'description': 'Jinx, una maniática e impulsiva criminal de Zaun, vive para sembrar el caos sin pararse a pensar en las consecuencias. Con un arsenal de juguetes letales a su disposición, desata las explosiones más brillantes y los estallidos más ruidosos para dejar un rastro de caos y pánico a su paso. Jinx detesta el aburrimiento y con una gran alegría deja su marca de pandemonio a dondequiera que vaya.'
    },
    {
        'id': 'ashe-adc',
        'campeon':'Ashe',
        'publisher':'ADC',
        'alter_ego':'La Arquera De Hielo',
        'first_appearance':'Lanzado En: 21/02/2009',
        'characters':'🥶🥶🥶',
